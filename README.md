...
- **Server PC&hellip;** &mdash; lets you mark a PC as the main store PC. Marking
  ...
  Server PC right now.
- **Import Beer Bible from Export File&hellip;** &mdash; bulk-populates this PC's
  own Beer Bible (see "The Beer Bible" above) from a product export (CSV/TSV,
  or an Excel .xlsx/.xlsm workbook), running every row's title through the
