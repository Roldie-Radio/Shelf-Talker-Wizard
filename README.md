...
- **Wine Food Pairings** (experimental, off by default &mdash; Settings &rarr; Experimental Features) &mdash; adds a **Food Pairing Suggestions** field to Wine / Spirits Shelf Talkers. Click **Suggest Pairings** to match the varietal or classification detected in the Product Title/Description (e.g. Cabernet Sauvignon, Chardonnay, Nebbiolo, Chianti, Albariño, Rioja) against a short built-in list of food pairings, then pick up to 3 to print under the description as a "Pairs Well With" line &mdash; or skip the suggestions and type your own. Italian, Spanish, French, and Portuguese classifications are matched by their appellation/chateau/village name as well as the grape, so a title reading "Barolo," "Vino Nobile di Montepulciano," "Rioja," "Saint-Émilion," "Chablis," or "Vinho Verde" resolves correctly (to Nebbiolo, Sangiovese, Tempranillo, Merlot, Chardonnay, and Vinho Verde respectively) without needing the grape spelled out &mdash; real Bordeaux and Burgundy in particular are almost always labeled by chateau/village rather than varietal. Portugal adds Vinho Verde, Douro Red (Touriga Nacional/Touriga Franca), and Port to the varietal list &mdash; a title naming both a grape and Vinho Verde (e.g. "Alvarinho, Vinho Verde") still resolves to the more specific Albariño match, while a bare "Vinho Verde" with no grape named matches on its own. Cabernet Sauvignon's Bordeaux match specifically means the Cabernet-dominant Left Bank (Médoc, Pauillac, Margaux, Saint-Julien, Saint-Estèphe); Merlot has its own separate Right Bank match (Saint-Émilion, Pomerol). Pinot Noir's Burgundy match splits into Côte de Nuits vs. Côte de Beaune, and Chardonnay's own Burgundy matches (Chablis, Meursault, Puligny-Montrachet, Chassagne-Montrachet) sit alongside its California ones. For a number of varietals (Cabernet Sauvignon, Malbec, Syrah/Shiraz, Pinot Noir, Sauvignon Blanc, Riesling, Nebbiolo, Sangiovese, Barbera, Pinot Grigio/Gris, Champagne/Sparkling, Albariño, Tempranillo, Garnacha/Grenache, Chardonnay, Zinfandel, Merlot), a country/region also mentioned in the title/description &mdash; e.g. "Napa Valley," "Mendoza, Argentina," "Barolo," or "Rías Baixas" &mdash; refines one of the 4 suggested pairings to something more specific to that region and appends the region to the match ("Malbec &mdash; Mendoza, Argentina," "Nebbiolo &mdash; Barolo, Piedmont," "Albariño &mdash; Rías Baixas, Galicia"); a title with no region wording still gets exactly the varietal's own base pairings. Domestic sub-regions are told apart by climate rather than lumped under one state-wide match &mdash; Cabernet Sauvignon alone tells Napa Valley (warmer), Sonoma County (cooler), Paso Robles, and Washington State apart, and Chardonnay, Zinfandel, and Merlot each carry their own California (or California-vs-Washington) split. Riesling also carries a second, independent refinement tier for Germany's Prädikatswein sweetness classification (Trocken, Kabinett, Spätlese, Auslese and beyond) &mdash; distinct from region since it's the sweetness level, not the place, that actually changes what food it pairs with &mdash; and a title naming both (e.g. "Riesling Spätlese Pfalz") gets both refinements applied at once ("Riesling &mdash; Pfalz, Germany, Spätlese"). While the toggle is on, **Tools &rarr; Wine Pairing Rules&hellip;** in the menu bar shows the full list of varietals, their match keywords, and any region or sweetness refinements, straight from the same rules Suggest Pairings uses. Turning the toggle off hides the field, the menu item, and the printed line again without deleting anything already on a talker.
